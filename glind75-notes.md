...
<details>
<summary>0310. Minimum Height Trees</summary>

- 木の高さを最小にする根は、木の中心になる。答えは高々 2 頂点
- 葉を外側から削っていくと、最後に残る 1 頂点または 2 頂点が木の中心になる
- 別解として、木の直径パスを 1 本求め、その中央を返してもよい
    - BFS/DFS を 2 回行うと直径の端点を求められる
    - 2 回目の探索で `parent` を持っておくと直径パスを復元できる
    - 直径パスが複数あっても、その中央の頂点集合は同じ木の中心になる

</details>

<details>
<summary>0056. Merge Intervals</summary>

- 区間を開始位置でソートしてから、直前までマージ中の区間と今見ている区間を比較するのが標準的か
- 差分配列+座標圧縮でも解けるが、長さ 0 の区間の扱いが複雑
